      ...
      <div className="w-full max-w-4xl relative z-10">
        ...
        {gameMode === "solo" && (
          <motion.div
            ...
            className="bg-quiz-card rounded-2xl p-8 border border-primary/20"
          >
            <h2 className="text-3xl font-bold mb-4">Modo Solo</h2>
        ...
        {gameMode === "multiplayer" && (
          <motion.div
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            className="bg-quiz-card rounded-2xl p-8 border border-secondary/20"
          >
            <h2 className="text-3xl font-bold mb-4">Modo Multiplayer</h2>
            <p className="text-muted-foreground mb-6">Em desenvolvimento...</p>
            <Button onClick={() => setGameMode("menu")} variant="outline">
              Voltar ao Menu
            </Button>
